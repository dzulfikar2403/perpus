        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{route(Auth::user()->type == 'admin' ? 'admin/authors/update' : 'petugas/authors/update', $pengarang->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror" name="tgl_lahir" rows="5" placeholder="Masukkan Tanngal lahir">{{ old('tgl_lahir') }}</input>
